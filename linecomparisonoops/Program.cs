...
namespace linecomparisonoops
{
    public class LineComparison
    {
        ...
        public void Display()
        {
            Console.WriteLine("Enter x1 x2 y1 y2 x3 x4 y3 y4 values : ");
        ...
        {
            double len1 = Calculation(x1, y1, x2, y2);
            double len2 = Calculation1(x3, y3, x4, y4);
            Console.WriteLine("line 1" + len1);
            Console.WriteLine("line 2" + len2);
